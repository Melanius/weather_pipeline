...
def initialize_schema() -> None:
    ...
    try:
        ...
        logger.info("  10/11 HYCOM 예보 테이블 생성 중...")
        cursor.execute(SQL_CREATE_HYCOM_FORECAST_TABLE)

        # ── 11단계: HYCOM 예보 Hypertable + 인덱스 ──
        logger.info("  11/13 HYCOM 예보 Hypertable + 인덱스 생성 중...")
        ...
        logger.info("  12/13 NOAA WW3 파랑 예보 테이블 생성 중...")
        cursor.execute(SQL_CREATE_NOAA_FORECAST_TABLE)

        # ── 13단계: NOAA WW3 예보 Hypertable + 인덱스 ──
        logger.info("  13/13 NOAA WW3 예보 Hypertable + 인덱스 생성 중...")
        ...
        logger.success(
            "DB 스키마 초기화 완료! "
            "(ECMWF 재분석/예보 + HYCOM 분석/예보 + NOAA WW3 예보 테이블 5개)"
        )
